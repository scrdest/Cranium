...
#[cfg_attr(target_os = "linux", link(name = "target/debug/deps/libcranium_api.so", kind = "dylib"))]
#[cfg_attr(target_os = "android", link(name = "target/debug/deps/libcranium_api.so", kind = "dylib"))]
